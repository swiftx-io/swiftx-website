  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-24">
      ...
      <p className="text-lg text-muted-foreground mb-12">
        Tell us about your project, and we&apos;ll help you bring it to life with our expertise in software development, cloud infrastructure, AI, security, and technical consulting.
      </p>
      <EstimateProjectForm />
    </div>
  );
